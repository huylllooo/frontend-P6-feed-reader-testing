...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('have feeds with defined, unempty URL', function() {
         ...
         */
        it('have feeds with defined, unempty name', function() {
            for (var i = 0; i < allFeeds.length; i++) {
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         it('have at least a single entry in the feed container', function() {
